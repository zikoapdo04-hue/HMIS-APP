    ...
    <div style={{ background: COLORS.bg, height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ background: GRADIENTS.heroBg, padding: '24px 20px 32px', flexShrink: 0, borderRadius: `0 0 ${RADIUS.xxl} ${RADIUS.xxl}`, boxShadow: SHADOWS.header, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
          <div style={{ width: 40 }} />
          <p style={{ fontFamily: FONT.cairo, fontSize: 16, fontWeight: 800, color: 'white', margin: 0 }}>بيانات الطبيب</p>
          <button
      ...
      {/* Content */}
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 16px', display: 'flex', flexDirection: 'column', gap: 10 }} dir="rtl">
        {/* Bio */}
        {bio !== '—' && (
          <div style={{ background: COLORS.card, border: `1.5px solid ${COLORS.cardBorder}`, borderRadius: RADIUS.xl, padding: '16px', boxShadow: SHADOWS.card }}>
            <p style={{ fontFamily: FONT.cairo, fontSize: 12, color: COLORS.textMuted, margin: '0 0 6px', fontWeight: 700 }}>نبذة تعريفية</p>
