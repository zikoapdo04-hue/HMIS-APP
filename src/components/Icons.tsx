/* ── Eye Icons ── */
export const EyeOpen = ({ size = 20 }: { size?: number }) => (
...
/* ── HMIS Logo ── */
export const HMISGlobe = ({ size = 90 }: { size?: number, color?: string }) => (
...
export const HMISShieldLogo = ({ size = 52 }: { size?: number, color?: string }) => (
